...
1. Since this is a multi-objective problem, our implementation used the weighted sum method to adapt the fitness function, just like it's specified in the article. But since most genetic operators are based on maximum fitness value, the fitness function was adapted to match this requirement. In this case, higher values indicate greater minimization of wastage and makespan.
...
3. With the environment activated, run the command below to install the necessary libraries:
